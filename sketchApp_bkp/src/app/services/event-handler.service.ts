...
export class EventHandlerService {
  ...
  // selectedThickness: DrawingThickness = DrawingThickness.THIN; //MEDIUM
  selectedThickness: DrawingThickness = DrawingThickness.THICK; //MEDIUM
  ...
  constructor(private fabricShapeService: FabricService) {}
